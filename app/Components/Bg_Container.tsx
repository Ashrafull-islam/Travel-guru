  ...
  />
   <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-transparent to-transparent pointer-events-none"></div>
      ...
      <div className="text-center ">
        <h1 className={`${mulish.variable} text-6xl md:text-[64px] p-3 font-light leading-10	text-[#FFFFFF]`}>Explore Your Travel</h1>
        <p  className={`${mulish.variable} md:w-[600px] mx-auto md:text-[16px] p-3 font-light leading-10	text-[#FFFFFF] `}>Dolor sit amet consectetur. Nullam suspendisse vitae ultricies dolor adipiscing. In et odio enim ac quis sapien urna eu phasellus.</p>
        <div className='flex p-3 md:p-0 text-[16px] leading-6'>
        </div>
        <div className={`${mulish.variable} p-5 border border-[#000000] inset-0 rounded-lg bg-gradient-to-b from-[#7BB0BC] via-transparent to-white md:w-[800px] text-[16px] mx-auto `}>
